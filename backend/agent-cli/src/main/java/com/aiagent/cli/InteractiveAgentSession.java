...
public class InteractiveAgentSession {
    ...
    private void executeTask(String task) {
        ...
        if (workspaceContext != null) {
            request.setWorkspacePath(workspaceContext.getRootPath());
            request.setSourceFiles(workspaceContext.getSourceFiles());

            Map<String, Object> metadata = new HashMap<>();
            metadata.put("buildTool", workspaceContext.getBuildTool());
            metadata.put("modules", workspaceContext.getModules());
            metadata.put("testFiles", workspaceContext.getTestFiles());
            request.setWorkspaceMetadata(metadata);
        }
